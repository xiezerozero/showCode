...
class DocParser {
    ...
    /** @var array 多个相同参数需要解析为数组的名称 */
    protected $array_params = ['param', 'required', 'optional'];
	...
	private function setParam($param, $value) {
	    if (!in_array($param, $this->array_params)) {
	        return true;
        }
...
//			$this->params [$param] = [$value];
//		} else if (in_array($param, $this->array_params)) {
//			if (is_string($this->params[$param])) {
//				$arr = array($this->params[$param], $value);
//			} else {
//				$arr = array_merge($this->params[$param], [$value]);
//			}
